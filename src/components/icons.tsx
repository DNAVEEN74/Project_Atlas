...
export { default as NotificationActiveIcon } from '@mui/icons-material/NotificationsActive';
export { default as NotificationOffIcon } from '@mui/icons-material/NotificationsOff';
...
export { default as EyeIcon } from '@mui/icons-material/RemoveRedEye';

// ========== DIFFICULTY & LEVEL ICONS ==========
export { default as DifficultyIcon } from '@mui/icons-material/SignalCellularAlt';
export { default as FireIcon } from '@mui/icons-material/Whatshot';
 ...
 * Use this to apply consistent sizing to Material UI icons
 */
...
/**
 * Example usage:
 * <HomeIcon sx={getIconSize('lg')} />
 * <CheckCircleIcon sx={{ ...getIconSize('md'), color: 'hsl(var(--accent-primary))' }} />
 */

// Export commonly used icon sets as groups
