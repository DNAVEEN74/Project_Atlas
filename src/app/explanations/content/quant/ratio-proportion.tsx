...
export default function RatioProportionContent() {
    return (
        <LessonLayout>
            ...
            <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-12 border border-neutral-800 shadow-2xl group">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                        {/* Balance beam */}
                        <div
                            className="w-64 h-2 bg-neutral-600 rounded-full"
                            style={{
                                transform: 'rotate(-5deg)',
                                transformOrigin: 'center',
                                animation: 'balanceSwing 3s ease-in-out infinite'
                            }}
                        >
                            {/* Left pan */}
                            <div className="absolute -left-4 top-2 w-16 h-12 border-2 border-teal-500/50 rounded-b-full bg-teal-500/20 flex items-center justify-center">
                                <span className="text-xl font-bold text-teal-400">3</span>
                            </div>
                            {/* Right pan */}
                            <div className="absolute -right-4 top-2 w-16 h-12 border-2 border-amber-500/50 rounded-b-full bg-amber-500/20 flex items-center justify-center">
                                <span className="text-xl font-bold text-amber-400">2</span>
                            </div>
                            {/* Center pivot */}
                            <div className="absolute left-1/2 -translate-x-1/2 -top-2 w-4 h-4 bg-neutral-400 rounded-full" />
                        </div>
                        {/* Pivot stand */}
                        <div className="absolute left-1/2 -translate-x-1/2 top-4 w-1 h-12 bg-neutral-600" />
                    </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black via-black/80 to-transparent">
                    ...
                    <p className="text-neutral-400 text-lg">The art of fair sharing — compare without calculating!</p>
                </div>
            </div>

            {/* WHY RATIO MATTERS */}
            <ConceptSection id="why" title="Why Ratios are Your Best Friend" icon="🤝">
                <div className="bg-gradient-to-r from-teal-900/20 to-transparent p-6 rounded-xl border-l-4 border-teal-500 mb-6">
                    <p className="text-lg">
                        ...
                        <span className="text-teal-400"> Ratio is the answer: 3:2!</span>
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-6">
                    {[
                        { icon: '💰', title: 'Partnership', desc: 'Profit sharing' },
                        { icon: '🧪', title: 'Mixtures', desc: 'Alligation problems' },
                        { icon: '🗺️', title: 'Maps', desc: 'Scale conversions' },
                        { icon: '👨‍🍳', title: 'Recipes', desc: 'Ingredient scaling' },
                    ].map((item, i) => (
                        <div key={i} className="p-4 bg-neutral-900 rounded-xl border border-neutral-800 text-center hover:border-teal-500/50 transition-all">
                            <div className="text-3xl mb-2">{item.icon}</div>
                            <h4 className="text-teal-400 font-bold">{item.title}</h4>
            ...
            {/* WHAT IS RATIO */}
            <ConceptSection id="intro" title="What is a Ratio? — The Pizza Analogy" icon="🍕">
                <p className="mb-4">
                ...
                <div className="bg-neutral-900 rounded-xl p-6 my-8 border border-neutral-800">
                    <h4 className="text-teal-400 font-bold text-center mb-4">🍕 The Pizza Party</h4>
            ...
            {/* TYPES OF RATIOS */}
            <ConceptSection id="types" title="Types of Ratios" icon="📊">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                    <div className="p-5 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-teal-500/50 transition-all">
                        <h4 className="text-teal-400 font-bold mb-3">📈 Compounded Ratio</h4>
            ...
            {/* COMBINING RATIOS */}
            <ConceptSection id="combining" title="Combining Ratios — The Chain Method" icon="🔗">
                ...
                <div className="my-8 p-6 bg-neutral-900 rounded-xl border border-neutral-800">
                    <h4 className="text-rose-400 font-bold text-center mb-6">The Step-by-Step Method</h4>
            ...
            {/* PROPORTION */}
            <ConceptSection id="proportion" title="Proportion — When Ratios are Equal" icon="⚖️">
                <p className="mb-4">
            ...
            <ConceptSection id="componendo" title="Componendo-Dividendo — The Advanced Trick" icon="🧮">
            ...
            {/* VARIATIONS */}
            <ConceptSection id="variations" title="Direct & Inverse Proportion" icon="↔️">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            ...
            <ConceptSection id="mistakes" title="Common Mistakes — Avoid These!" icon="⚠️">
                <div className="space-y-4 my-6">
                    <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                        <h4 className="text-red-400 font-bold">❌ Confusing Ratio with Fraction</h4>
                    ...
                    <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                        <h4 className="text-red-400 font-bold">❌ Adding Ratios Directly</h4>
                        <p className="text-sm text-neutral-400 mt-1">
                    ...
                    <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                        <h4 className="text-red-400 font-bold">❌ Wrong Proportionality Type</h4>
                        <p className="text-sm text-neutral-400 mt-1">
                    ...
                    <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                        <h4 className="text-red-400 font-bold">❌ Ignoring the "k" Factor</h4>
                        <p className="text-sm text-neutral-400 mt-1">
