#!/usr/bin/env python3
"""
Batch Extractor for SSC CGL 2023 Papers
...
def main():
    papers_dir = Path(__file__).parent.parent.parent / "docs" / "PYQs" / "SSC" / "CGL" / "2023"
    output_dir = Path(__file__).parent / "output" / "2023"
    output_dir.mkdir(parents=True, exist_ok=True)
    
    papers = list(papers_dir.glob("*.pdf"))
    
    print("=" * 60)
    print("BATCH EXTRACTION - SSC CGL 2023 (REASONING + QUANT)")
    print("=" * 60)
    ...
    # Save to single JSON
    output_file = output_dir / "ssc_cgl_2023_all.json"
